  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* blob 3: center, theme color large — use inline transform to keep centered */}
        <div className="absolute w-[600px] h-[600px] rounded-full blur-3xl"
          style={{ top: '50%', left: '50%', backgroundColor: `${g.o1}4D`, transition: 'background-color 0.8s ease', animation: 'float3 7s ease-in-out infinite' }} />
      </div>
